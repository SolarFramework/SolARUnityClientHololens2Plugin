...
bool MixedReality::EnableMixedReality()
{
 ...
 //   {
	//	// Not in UI Thread, if UWP app is initialized, try :
	//	coreWindow = winrt::Windows::ApplicationModel::Core::CoreApplication::MainView().CoreWindow();
	//}
	//
	//m_holoSpace = winrt::Windows::Graphics::Holographic::HolographicSpace::CreateForCoreWindow(coreWindow /* winrt::Windows::UI::Core::CoreWindow::GetForCurrentThread() */);
